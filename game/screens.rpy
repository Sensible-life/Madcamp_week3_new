...
screen say(who, what):
    ...
    window:
        ...
        # Change background based on the character speaking
        if who == "침채린":
            background "gui/textbox_charin.png"
        elif who == "주하민":
            background "gui/textbox_hamin.png"
        elif who == "주유재":
            background "gui/textbox_yujae.png"
        elif who == "궤하린":
            background "gui/textbox_harin.png"
        elif who == "김솔풍":
            background "gui/textbox_solpoong.png"
        elif who == "???":
            background "gui/textbox_who.png"
        elif who == "[player_name]":
            background "gui/textbox_player.png"
        else:
